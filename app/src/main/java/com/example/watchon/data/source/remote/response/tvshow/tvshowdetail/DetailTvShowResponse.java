...
public class DetailTvShowResponse {
	...
	public DetailTvShowResponse(int id, String firstAirDate, String overview, String posterPath, String name, List<Integer> episodeRunTime, List<TvShowGenresItem> genres) {
		this.id = id;
